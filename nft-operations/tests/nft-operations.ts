...
import { NftOperations } from "../target/types/nft_operations";

describe("nft-operations", () => {
  // Configure the client to use the local cluster.
  anchor.setProvider(anchor.AnchorProvider.env());

  const program = anchor.workspace.NftOperations as anchor.Program<NftOperations>;
  ...
  const metadata = {
    name: "PG Token",
    symbol: "PGT",
    uri: "https://red-chilly-carp-862.mypinata.cloud/ipfs/QmXRke9dDacpaeroBykCxR8bBybhodjxDdcq6EQZ5Zk8n3",
    decimals: 9
  }
  const mintAmount = 10;
